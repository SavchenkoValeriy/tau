...
// CHECK-LABEL:   @"unsigned long test_cstyle_ui32_to_ui64(unsigned int)"
// CHECK:           %[[#RES:]] = air.zext %[[#INP:]] : ui32 to ui64
// CHECK-NEXT:      br ^bb[[#EXIT:]](%[[#RES]] : ui64)
...
// CHECK-LABEL:   @"unsigned long test_static_ui32_to_ui64(unsigned int)"
// CHECK:           %[[#RES:]] = air.zext %[[#INP:]] : ui32 to ui64
// CHECK-NEXT:      br ^bb[[#EXIT:]](%[[#RES]] : ui64)

unsigned long test_implicit_si32_to_ui64(int a) { return a; }
// CHECK-LABEL:   @"unsigned long test_implicit_si32_to_ui64(int)"
// CHECK:           %[[#RES:]] = air.sext %[[#INP:]] : si32 to ui64
// CHECK-NEXT:      br ^bb[[#EXIT:]](%[[#RES]] : ui64)

long test_implicit_ui32_to_si64(unsigned a) { return a; }
// CHECK-LABEL:   @"long test_implicit_ui32_to_si64(unsigned int)"
// CHECK:           %[[#RES:]] = air.zext %[[#INP:]] : ui32 to si64
// CHECK-NEXT:      br ^bb[[#EXIT:]](%[[#RES]] : si64)

int test_implicit_si64_to_si32(long a) { return a; }
// CHECK-LABEL:   @"int test_implicit_si64_to_si32(long)"
// CHECK:           %[[#RES:]] = air.trunc %[[#INP:]] : si64 to si32
// CHECK-NEXT:      br ^bb[[#EXIT:]](%[[#RES]] : si32)

int test_cstyle_si64_to_si32(long a) { return (int)a; }
// CHECK-LABEL:   @"int test_cstyle_si64_to_si32(long)"
// CHECK:           %[[#RES:]] = air.trunc %[[#INP:]] : si64 to si32
// CHECK-NEXT:      br ^bb[[#EXIT:]](%[[#RES]] : si32)

int test_static_si64_to_si32(long a) { return static_cast<int>(a); }
// CHECK-LABEL:   @"int test_static_si64_to_si32(long)"
// CHECK:           %[[#RES:]] = air.trunc %[[#INP:]] : si64 to si32
// CHECK-NEXT:      br ^bb[[#EXIT:]](%[[#RES]] : si32)
