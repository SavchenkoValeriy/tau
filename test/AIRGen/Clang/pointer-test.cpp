...
// CHECK:       func.func @"int *test_simple(int *a)"(%arg0: !air.ptr<si32>) -> !air.ptr<si32> {
...
// CHECK:       func.func @"float ****test_nested(float ****a)"(%arg0: !air.ptr<!air.ptr<!air.ptr<!air.ptr<f32>>>>) -> !air.ptr<!air.ptr<!air.ptr<!air.ptr<f32>>>> {
